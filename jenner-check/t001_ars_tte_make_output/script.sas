/****************************************************************************
* jenner-check bundle: t005_ars_tte_make_output
*
* Exercises this repo's time-to-event report builder, unmodified:
*   - %ars_tte_make_output
*
* This macro reshapes an ARS-normalized Cox PH + Kaplan-Meier long dataset
* (the kind produced by %ars_tte_production_analysis) into report-ready
* col0/col1/col2 rows: descriptive time-to-event stats, cumulative incidence,
* censored counts, KM median (95% CI), and the Cox hazard ratio (95% CI,
* p-value). The macro definition below is copied verbatim from
* ars_tte_make_output.sas. A small mock ARS long dataset built from the exact
* operation IDs the README documents (OP_TTE_DESC, OP_TTE_KM_CINC,
* OP_TTE_CENSOR, OP_TTE_KM_MEDIAN, OP_TTE_COX_HR) stands in for
* %ars_tte_production_analysis output, so the reshape runs with no libname.
****************************************************************************/

/* ===== ars_tte_make_output.sas (verbatim) =========================== */
/****************************************************************************
...
/* ===== mock ARS long TTE results + driver =========================== */
/* Time to sustained respiratory improvement, two arms, KM timepoint 28. */
data work.ars_tte_long;
    length source_system $8 analysis_id $40 operation_id $40 operation_role $20
           parameter_cd $40 parameter $200 treatment $200 contrast $400 display_id $80;
    length result_numeric 8;
    infile datalines dsd truncover;
    input operation_id $ operation_role $ treatment $ result_numeric;

    source_system='SAS';
    analysis_id='AN_TTE_COX_KM';
    parameter_cd='TTRS';
    parameter='Time to Respiratory Improvement';
    display_id='T_TTRS';
    datalines;
OP_TTE_DESC,N,AON-D21,60
OP_TTE_DESC,MEAN,AON-D21,15.4
OP_TTE_DESC,SD,AON-D21,6.2
OP_TTE_DESC,MEDIAN,AON-D21,14
OP_TTE_DESC,MIN,AON-D21,3
OP_TTE_DESC,MAX,AON-D21,28
OP_TTE_DESC,N,Placebo,58
OP_TTE_DESC,MEAN,Placebo,19.1
OP_TTE_DESC,SD,Placebo,6.8
OP_TTE_DESC,MEDIAN,Placebo,20
OP_TTE_DESC,MIN,Placebo,4
OP_TTE_DESC,MAX,Placebo,28
OP_TTE_KM_CINC,PCT,AON-D21,72.5
OP_TTE_KM_CINC,PCT,Placebo,55.2
OP_TTE_CENSOR,N_CENS,AON-D21,16
OP_TTE_CENSOR,PCT_CENS,AON-D21,26.7
OP_TTE_CENSOR,N_CENS,Placebo,26
OP_TTE_CENSOR,PCT_CENS,Placebo,44.8
OP_TTE_KM_MEDIAN,ESTIMATE,AON-D21,13
OP_TTE_KM_MEDIAN,LCL,AON-D21,10
OP_TTE_KM_MEDIAN,UCL,AON-D21,17
OP_TTE_KM_MEDIAN,ESTIMATE,Placebo,19
OP_TTE_KM_MEDIAN,LCL,Placebo,15
OP_TTE_KM_MEDIAN,UCL,Placebo,24
OP_TTE_COX_HR,ESTIMATE,,1.62
OP_TTE_COX_HR,LCL,,1.11
OP_TTE_COX_HR,UCL,,2.36
OP_TTE_COX_HR,PVALUE,,0.0121
;
run;
...
title "ARS time-to-event report rows (col0/col1/col2)";
proc print data=work.page_tte noobs;
    var page order index col0 col1 col2;
run;
title;
